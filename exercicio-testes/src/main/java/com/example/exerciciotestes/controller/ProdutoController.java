...
public class ProdutoController {
    ...
    @PostMapping
    public ResponseEntity<Produto> salvaProduto(@Valid @RequestBody ProdutoRequest produtoRequest){

        Produto produto =this.produtoService.salvaProduto(produtoRequest);
